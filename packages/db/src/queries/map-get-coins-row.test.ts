...
describe("mapGetCoinsRowsToCoinRecords", () => {
  ...
  it("preserves issuer ISO Code for direct and parent issuer records", () => {
    const createRow = (overrides: Partial<GetCoinsRow>): GetCoinsRow => ({
      id: "coin-issuer",
      title: "Issuer Coin",
      createdAt,
      updatedAt,
      ...
      faceValueNumericValue: 1,
      currencyId: "currency-1",
      currencyCode: "test-unit",
      currencyName: "Test Unit",
      currencyFullName: "Test Unit",
      currencyCreatedAt,
      currencyUpdatedAt,
      orientationId: null,
      ...
      obverseDescription: null,
      obverseLettering: null,
      obverseEngraverId: null,
      obverseEngraverCode: null,
      obverseEngraverName: null,
      obverseEngraverCreatedAt: null,
      obverseEngraverUpdatedAt: null,
      reverseDescription: null,
      reverseLettering: null,
    ...
    const rows: GetCoinsRow[] = [
      createRow({
        id: "coin-issuer-parent",
        title: "Parented Issuer Coin",
