...
import { DISTRIBUTION_DELETE_EXISTING_COINS_REASSIGN_REQUIRED_MESSAGE } from "../actions"
...
vi.mock("../form-workflow/distribution-create-form", () => ({
  DistributionCreateForm: () =>
    createElement("div", null, "DistributionCreateForm"),
}))

vi.mock("../form-workflow/distribution-edit-form", () => ({
